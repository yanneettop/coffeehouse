...
export default function BrunchSection() {
  ...
  return (
    <section
      ref={sectionRef}
      id="brunch"
      className="section-pinned bg-cream-paper flex items-center justify-center z-40"
    >
      <div
        ref={cardRef}
      ...
      >
        <div className="relative w-full h-full p-6 md:p-10 lg:p-12">
          ...
          >
            <img
              src="/brunch_plate.jpg"
              alt="Brunch plate with sandwich"
          ...
          <div className="absolute right-6 md:left-[52%] top-[45%] md:top-[10%] w-[90%] md:w-[42%]">
            ...
            <div>
              <p className="font-body text-sm md:text-base text-espresso/80 leading-relaxed mb-6 md:mb-8">
                Big plates, proper portions. Full breakfasts, stacked burgers, and avocado toasts done right — served all day, no questions asked.
              </p>
              <p className="font-body text-sm md:text-base text-espresso/80 leading-relaxed mb-6 md:mb-8">
                Whether you're easing into a weekend or powering through a weekday, our brunch hits the spot every time. No 12pm cut-off, no fuss.
              </p>
